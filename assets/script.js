...
$(document).ready(function(){
    ...
    const mostraMsgMes = (texto) =>{
        ...
        switch(texto){
            case "20/11": titulo = "20 de Novembro de 2021"; mensagem = "<p>Esse foi o dia que nos conhecemos! Ou pelo menos, o dia que nos conhecemos já sabendo que dali pra frente poderiamos ter alguma coisa juntos.</p><p> e conversamos tão pouquinho, mas já foi o suficiente para eu entender naquele momento que você era diferente Eu quis de verdade, a partir desse dia, te conhecer melhor </p><p>E eu estava certo, você é incrível!</p>";break;
            case "06/07": titulo = "06 de Julho de 2022"; mensagem = "<p>Foi nos 3 dias de EBF.<br>Você estava linda, como sempre nos 3 dias .</p><p>me sentia cada vez mais proximo de vc,mas ainda não tinha segurança pra falar oque sentia❤️</p>";break;
            case "06/12": titulo = "06 de Dezembro de 2022"; mensagem = "<p>O dia em que falamos um pra o outro que se gostavamos finamnete ja não aguentava mais guarda oque eu sinto</p>";break;
            ...
            case "final": titulo = "10 de Dezembro de 2022"; mensagem = "<section class='text-center mt-5 mb-5'><p><strong>O dia em que ela disse<br><span class='letra2 letra-vermelha'>SIM</span></strong></p></section>";break;
        }
